...
if (channel === null) return;
    ...
    const noMessage = new MessageEmbed()
      .setDescription(`<:bfdno:832931445991276584>   | Ich habe keine Nachricht mit dieser ID gefunden!`)
      .setColor("FF2052")
  ...
  return message.channel.send(noMessage);
      ...
      .setColor("BLUE")
      .addField(`Antworten von ${message.author.tag}`, replyQuery)
      .setFooter("Status: Beantwortet")
      .setTimestamp();

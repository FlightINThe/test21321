...
module.exports = {
  name: "reroll",
  description:
    "Holen Sie sich eine Liste aller Befehle und lernen Sie sogar alle Befehls-Detials kennen",
  usage: "help <cmd>",
  category:"giveaway",
    ...
    .catch((e) => {
        if(e.startsWith(`Giveaway mit Nachrichten-ID ${giveaway.messageID} wird nicht beendet.`)){
            message.channel.send('Dieses Werbegeschenk ist nicht beendet!');
        } else {
            console.error(e);
